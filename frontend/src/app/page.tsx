        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 relative">
          ...
          <div>
            ...
            <div className="flex items-center justify-between gap-4 mt-1">
              ...
              {/* Mobile only: Observatory button */}
              <Link
                href="/observatory"
      ...
      <footer className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            This calendar runs itself. An autonomous AI system using Claude&apos;s multi-model architecture (Haiku, Sonnet, Opus) discovers, validates, and curates Austin&apos;s AI events daily. A self-monitoring layer evaluates every run, and a repair agent autonomously fixes issues and pushes code—no humans required. Built with Claude Code.
          </p>
        </div>
      </footer>
    </div>
