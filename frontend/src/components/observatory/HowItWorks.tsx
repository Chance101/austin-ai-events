    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-6">
      ...
      <div className="hidden md:block">
        <div className="flex items-center justify-between">
          {steps.map((step, index) => (
            <div key={step.label} className="flex items-center">
              <div className="flex flex-col items-center text-center bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-4 min-w-[140px]">
                <div className="w-12 h-12 rounded-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 flex items-center justify-center text-2xl mb-2">
                  {step.icon}
                </div>
        ...
        <div className="relative mt-3">
          ...
          <span className="absolute left-1/2 -translate-x-1/2 bottom-0 text-sm font-medium text-blue-500 dark:text-blue-400 bg-white dark:bg-gray-800 px-3 py-0.5 rounded-full border border-blue-200 dark:border-blue-800">
      ...
      <div className="md:hidden space-y-3">
        {steps.map((step, index) => (
          <div key={step.label} className="flex flex-col items-center">
            <div className="flex items-center gap-4 w-full bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-3">
              <div className="w-10 h-10 rounded-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 flex items-center justify-center text-xl flex-shrink-0">
                {step.icon}
              </div>
            ...
            {index < steps.length - 1 && (
              <div className="my-1 text-gray-300 dark:text-gray-600">
        ...
        <div className="flex items-center justify-center gap-2 pt-2">
          <span className="inline-flex items-center gap-1.5 text-sm font-medium text-blue-500 dark:text-blue-400 bg-white dark:bg-gray-800 px-3 py-0.5 rounded-full border border-blue-200 dark:border-blue-800">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h4 className="text-md font-semibold text-gray-900 dark:text-white">The Bigger Picture</h4>
        </div>
