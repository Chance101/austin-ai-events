    ...
    <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6 h-full flex flex-col">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-blue-50 rounded-lg p-4 text-center">
          <p className="text-2xl font-bold text-blue-600">{averageEventsPerRun.toFixed(1)}</p>
          <p className="text-sm text-gray-500">Avg events/run</p>
        </div>
        <div className="bg-purple-50 rounded-lg p-4 text-center">
          <p className="text-2xl font-bold text-purple-600">{totalEventsAdded}</p>
      ...
      <div className="mt-4 pt-4 border-t border-gray-100">
        <div className="flex items-center justify-between text-sm">
          ...
          <span className="font-medium">{successfulRuns}/{totalRuns} runs</span>
        </div>
